// HTTP durum kodları (404, 500 vb.) için
using System.Net;
// Hata cevabını JSON olarak yazmak için
using System.Text.Json;

namespace MiniCrmApi.Middlewares
{
    // Tüm istek hattında (pipeline) hataları yakalayıp tek yerde yönetmek için bir middleware.
